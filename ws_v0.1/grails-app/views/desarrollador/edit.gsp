...
<html>
    ...
    <body>
		...
		<div class="breadcrumb-box">
		  <div class="container">
			<ul class="breadcrumb">
			  ...
			  <li><g:link action="show" resource="${this.desarrollador}"><g:message code="default.show.label" args="[entityName]" /></g:link></li>
			  <li class="active"><g:message code="default.edit.label" /> ${desarrollador.nombre}</li>
			</ul>	
		  </div>
		</div>
		<!-- .breadcrumb-box -->
        ...
        <div id="edit-desarrollador" class="content scaffold-edit" role="main">
            ...
            <g:form resource="${this.desarrollador}" method="PUT">
                ...
                <fieldset class="buttons">
                    ...
                    <g:link name="footer-close" class="close" action="show" resource="${this.desarrollador}"><g:message code="default.button.close.label" default="Close" /></g:link>
                </fieldset>
            </g:form>
        </div>
    </body>
