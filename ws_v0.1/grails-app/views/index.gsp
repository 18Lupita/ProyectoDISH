...
<g:if test="${session.getAttribute("username_establecimiento_logo")}">
	<img src="${request.contextPath}/assets/upload/${session.getAttribute("username_establecimiento_logo")}" style="width:250px;position:relative;top:-25px;">
</g:if>        
<g:else>
        ...
        <div class="login_box">
            ...
            <g:form action="authenticate" controller="login" autocomplete="off" name="authenticate_form">
