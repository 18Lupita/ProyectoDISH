...
<html>
    ...
    <body>
        ...
        <a href="#edit-userLGRoleLG" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
        ...
        <div id="edit-userLGRoleLG" class="content scaffold-edit" role="main">
            ...
            <g:form resource="${this.userLGRoleLG}" method="PUT">
                <g:hiddenField name="version" value="${this.userLGRoleLG?.version}" />
                <fieldset class="form">
