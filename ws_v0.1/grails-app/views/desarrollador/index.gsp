...
<html>
    ...
    <body>
        ...
        <div class="nav_topbar" role="navigation">
            <ul>
                ...
                <div class="col-xs-6 col-xs-offset-2" style="float:right;padding: 0px;">
					<g:if test="${desarrolladorCount != 0 || session.getAttribute('desarrollador_search_word')}">
					<g:form action="index" method="POST" name="search_form">
						<div class="input-group">
							<div class="input-group-btn search-panel">
								<button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown">
									<span id="search_concept">${session.getAttribute('desarrollador_search_rows')} Registros</span> <span class="caret"></span>
								</button>
							...
							<input type="hidden" name="search_rows" id="search_rows" value="${session.getAttribute('desarrollador_search_rows')}">
							<input type="hidden" name="search_clean" id="search_clean" value="0">
							<input type="text" class="form-control" name="search_word" id="search_word" placeholder="Palabra a buscar..." value="${session.getAttribute('desarrollador_search_word')}">
        ...
        <div id="list-desarrollador" class="content scaffold-list" role="main">
			...
			<table>
				<g:if test="${desarrolladorCount != 0}">
                <thead>
                    <tr>
                        <g:sortableColumn property="nombre" title="${message(code: 'desarrollador.nombre.label', default: 'Name')}" />
                        <g:sortableColumn property="telefono" title="${message(code: 'desarrollador.telefono.label', default: 'Phone')}" />
                        <g:sortableColumn property="isManager" title="${message(code: 'desarrollador.isManager.label', default: 'Maager')}" />
                        <th style="width:100px" class="sortable"><a href="#"><g:message code="default.actions.label" default="Actions" /></a></th>
                    </tr>
                </thead>
				</g:if>
                <tbody>
                    <g:each in="${desarrolladorList}" var="item" status="i">
