...
<html>
    ...
    <body>
		...
		<div class="breadcrumb-box">
		  <div class="container">
			<ul class="breadcrumb">
			  ...
			  <li class="active"><g:message code="default.edit.label" /> ${userLG.nombre}</li>
			</ul>	
		  </div>
		</div>
		<!-- .breadcrumb-box -->
        ...
        <div id="edit-userLG" class="content scaffold-edit" role="main">
            ...
            <g:form resource="${this.userLG}" method="PUT">
                <g:hiddenField name="version" value="${this.userLG?.version}" />
                <fieldset class="form">
                 %{--
                    <f:all bean="userLG"/>
                 --}%
                    ...
                    <f:with bean="userLG">
                        ...
                        <div class="fieldcontain">
                            ...
                            <g:select name="role" from="${roles}" optionKey="id" optionValue="nombre" value="${userLG?.getRolID()}"/>
                        </div>
